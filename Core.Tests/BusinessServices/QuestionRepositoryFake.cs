...
internal class QuestionRepositoryFake : IQuestionRepository
{
    ...
    internal QuestionRepositoryFake(IQuestion initialTextualQuestion)
    {
        _currentTextualQuestion = initialTextualQuestion;
    }

    public static QuestionRepositoryFake CreateWithInitialQuestion(int studentId, IQuestion initialTextualQuestion)
    {
        Students.TryAdd(studentId, new Student(initialTextualQuestion));
        var student = Students[studentId];
        student.AnsweringQuestion = initialTextualQuestion;
        return new QuestionRepositoryFake(initialTextualQuestion);
    }
